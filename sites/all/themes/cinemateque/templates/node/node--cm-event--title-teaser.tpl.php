...
?>
<?php if($field_cm_event_subtitle){ ?> <div class="teaser-with-sub"> <?php } ?>
<div class="node-title-teaser node-title-teaser-cm-event node-title-teaser-content-type">
...
<?php if($field_cm_event_subtitle){ ?> </div> <?php } ?>
