                ...
                <div class="search-snippet-info">
                    ...
                    <?php if ($info) : ?>
                        <p class="search-info"><?php print $info; ?>
                            ...
                            <?php if (isset($variables['item']->field_toptix_purchase['und'][0]['value'])){
                            if ($variables['item']->field_toptix_purchase['und'][0]['value'] != "") { ?>                             <!--<span class="purchase-btn"> Purchase </span>-->
